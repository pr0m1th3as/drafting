...
%!error<geom.centroid: P must be a real numeric matrix.> ...
%! geom.centroid ({1, 2})
%!error<geom.centroid: P must contain at least one point.> ...
%! geom.centroid (zeros (0, 2))
%!error<geom.centroid: P must not contain NaN or Inf values.> ...
%! geom.centroid ([0, 0; 1, 1; 2, 2; NaN, 3])
