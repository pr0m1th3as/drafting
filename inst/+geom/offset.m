...
%!error<geom.offset: P must be a real numeric matrix.> ...
%! geom.offset ({1, 2}, 1)
%!error<geom.offset: P must be an N-by-2 matrix of point coordinates.> ...
%! geom.offset (ones (3, 3), 1)
%!error<geom.offset: P must contain at least one point.> ...
%! geom.offset (zeros (0, 2), 1)
%!error<geom.offset: P must not contain NaN or Inf values.> ...
%! geom.offset ([0, 0; 1, 1; 2, 2; NaN, 3], 1)
