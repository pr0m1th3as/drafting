...
%!error<geom.curveoffset: P must be a real numeric matrix.> ...
%! geom.curveoffset ({1, 2}, 1)
%!error<geom.curveoffset: P must be an N-by-2 matrix of point coordinates.> ...
%! geom.curveoffset (ones (3, 3), 1)
%!error<geom.curveoffset: P must contain at least one point.> ...
%! geom.curveoffset (zeros (0, 2), 1)
%!error<geom.curveoffset: P must not contain NaN or Inf values.> ...
%! geom.curveoffset ([0, 0; 1, 1; 2, 2; NaN, 3], 1)
