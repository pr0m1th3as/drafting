...
%!error<geom.triangulate: P must be a real numeric matrix.> ...
%! geom.triangulate ({1, 2})
%!error<geom.triangulate: P must be an N-by-2 matrix of point coordinates.> ...
%! geom.triangulate (ones (3, 3))
%!error<geom.triangulate: P must contain at least one point.> ...
%! geom.triangulate (zeros (0, 2))
%!error<geom.triangulate: P must not contain NaN or Inf values.> ...
%! geom.triangulate ([0, 0; 1, 1; 2, 2; NaN, 3])
