...
%!error<geom.transform: P must be a real numeric matrix.> ...
%! geom.transform ({1, 2}, 'scale', 2)
%!error<geom.transform: P must contain at least one point.> ...
%! geom.transform (zeros (0, 2), 'scale', 2)
%!error<geom.transform: P must not contain NaN or Inf values.> ...
%! geom.transform ([0, 0; 1, 1; 2, 2; NaN, 3], 'scale', 2)
