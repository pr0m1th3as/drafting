...
%!error<geom.isrectilinear: P must be a real numeric matrix.> ...
%! geom.isrectilinear ({1, 2})
%!error<geom.isrectilinear: P must be an N-by-2 matrix of point coordinates.> ...
%! geom.isrectilinear (ones (3, 3))
%!error<geom.isrectilinear: P must contain at least one point.> ...
%! geom.isrectilinear (zeros (0, 2))
%!error<geom.isrectilinear: P must not contain NaN or Inf values.> ...
%! geom.isrectilinear ([0, 0; 1, 1; 2, 2; NaN, 3])
