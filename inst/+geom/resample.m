...
%!error<geom.resample: P must contain at least two points.> ...
%! geom.resample ([3, 4], 5)
%!error<geom.resample: P must be a real numeric matrix.> ...
%! geom.resample ({1, 2}, 5)
%!error<geom.resample: P must be an N-by-2 matrix of point coordinates.> ...
%! geom.resample (ones (3, 3), 5)
%!error<geom.resample: P must contain at least one point.> ...
%! geom.resample (zeros (0, 2), 5)
%!error<geom.resample: P must not contain NaN or Inf values.> ...
%! geom.resample ([0, 0; 1, 1; 2, 2; NaN, 3], 5)
