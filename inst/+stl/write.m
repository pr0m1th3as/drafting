...
%!error<stl.write: S must be a non-empty struct array of sections.> ...
%! stl.write ('a.stl', 42)
%!error<stl.write: section 1: P must be an N-by-2 matrix of point coordinates.> ...
%! stl.write (tempname (), {1, 2}, [0, 1])
%!error<stl.write: section 1: P must be a real numeric matrix.> ...
%! stl.write (tempname (), 'abc', [0, 1])
%!error<stl.write: section 1: P must contain at least one point.> ...
%! stl.write (tempname (), zeros (0, 2), [0, 1])
%!error<stl.write: section 1: P must not contain NaN or Inf values.> ...
%! stl.write (tempname (), [0, 0; 1, 1; 2, 2; NaN, 3], [0, 1])
