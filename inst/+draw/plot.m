...
%!demo
%! ## `draw.plot` renders a drawing at equal aspect, honouring layer, line type
%! ## and colour.  It plots what `draw.entities` produces, which is what the
